 ...
 *
 */
public class StockDataReaderModified {
    ...
    public StockDataReaderModified(String stockTicker, int TimeSeries) {
        symbol = stockTicker;
        time = TimeSeries;
    }
    ...
    public HashMap<Integer, StockData> fetchData() throws IOException {
        ...
        return helperFunction(url, label, dateLabel, interval, trend);
    }
    ...
    public HashMap<Integer, StockData> fetchTrendlineData() throws IOException {
        ...
        return helperFunction(urlTrend, label, dateLabel, interval, trend);
    }




    public HashMap<Integer, StockData> helperFunction(URL url, String label, String dateLabel, String interval, boolean trend) throws IOException {
